...
<head>
    ...
    <title>MOBI-Boutique - Contact</title>
          ...
          <div class="container"><a href="boutique.php" class="navbar-brand home"><img src="logo/mobism.png" draggable="false" alt="MobiSM logo" class="d-none d-md-inline-block"><img src="logo/mobism.png" draggable="false" alt="MOBISM logo" class="d-inline-block d-md-none"><span class="sr-only">Mobi-Boutique - aller à la page d'accueile</span></a>
            ...
            <div id="navigation" class="navbar-collapse collapse">
              <ul class="nav navbar-nav ml-auto">
                ...
                <!-- ========== Contact dropdown ==================-->
                <li class="nav-item dropdown active"><a href="contact.php" >Contact </a>
          ...
          <div class="row d-flex align-items-center flex-wrap">
            ...
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="index-2.html">Accueil</a></li>
        ...
        <div id="contact" class="container">
          <section class="bar">
            <div class="row">
              <div class="col-md-12">
                <div class="heading">
                  <h2>Nous sommes là pour vous aider <img src="logo/se.gif" draggable="false" alt="MobiSM logo" width="7%"></h2>
                </div>
                <p class="lead">Êtes-vous curieux de savoir quelque chose? Avez-vous un problème avec nos produits? Nous sommes là pour vous aider et répondre à vos questions et demandes de renseignements.</p>
                <p class="text-sm">N'hésitez pas à nous contacter, notre centre de service client travaille pour vous 24h / 24 et 7j / 7.</p>
              </div>
            </div>
          </section>
          <section>
            <div class="row text-center">
              <div class="col-md-4">
                <div class="box-simple">
                  ...
                  <p>Rue 8002, a l'espace de Tunis<br>                                        Bureau n*2-4 2e étage Mont-plaisir 1073 Tunis<br>                                        Tunis,  <strong>Tunisie</strong></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="box-simple">
                  ...
                  <p>Appelez-nous de l'intérieur de la Tunisie</p>
                  <p><strong>+216 51 110 112</strong></p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="box-simple">
                  <div class="icon-outlined"><i class="fa fa-envelope"></i></div>
                  <h3 class="h4">Support électronique</h3>
                  <p>N'hésitez pas à nous écrire un E-mail.</p>
                  <ul class="list-unstyled text-sm">
                    <li><strong><a href="mailto:">support@mobi-sm.tn</a></strong></li>
                ...
                <form>
                  <div class="row">
                    ...
                    <div class="col-sm-12 text-center">
                      <button type="submit" class="btn btn-template-outlined"><i class="far fa-envelope"></i> Envoyer le message</button>
                    </div>
                  </div>
                </form>
              </div>
...
'geometry': {
'type': 'Point',
'coordinates': [10.1872468,36.8187232]
}
}
]
}
